...
( function($) {
	...
	$.widget( "ui.gmap", {
		...
		_unwrap: function(a) {
			if ( !a ) {
				return null;
			} else if ( a instance of jQuery ) {
				return a[0];
			} else if ( a instance of Object ) {
				return a;
			}
			return $('#'+a)[0];
		}
	...
	jQuery.fn.extend( {
		...
		rightclick: function(a) {
			return this.addEventListener('right click', a);
		},
		...
		mouseout: function(a) {
			return this.addEventListener('mouse out', a);
		},
		...
		dragend: function(a) {
			return this.addEventListener('drag end', a );
		},
		...
		addEventListener: function(a, b) {
			if ( google.maps && this[0] instance of google.maps.MVCObject ) {
